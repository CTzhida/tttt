...
var patch = (0, _init.init)([_class.classModule, _style.styleModule, _props.propsModule, _eventlisteners.eventListenersModule]);
var vnode;
var nextKey = 11; //起始id
...
function add() {
  ...
  data = [{
    ...
    desc: n.desc,
    elmHeight: 0
  }].concat(data); //添加需要调用两次render，因为他是一个异步函数，更新视图可能会快于 遍历数据
...
function movieView(movie) {
  ...
  (0, _h.h)('div', movie.title), //标题
  (0, _h.h)('div', movie.desc), //描述
  (0, _h.h)('div.btn.rm-btn', {
    on: {
      click: [remove, movie]
    }
  }, 'x') //注册移除事件，传入当前节点数据
...
function view(data) {
  return (0, _h.h)("div", [(0, _h.h)("h1", "Top 10 movies"), (0, _h.h)("div", [(0, _h.h)("button.btn.add", {
    on: {
      click: add
    }
  }, "Add"), "Stroy by：", (0, _h.h)("span.btn-group", [(0, _h.h)("button.btn.rank", {
    class: {
      active: sortBy === 'rank'
    },
    on: {
...
},{"snabbdom/build/package/h":"../node_modules/snabbdom/build/package/h.js","snabbdom/build/package/init":"../node_modules/snabbdom/build/package/init.js","snabbdom/build/package/modules/class":"../node_modules/snabbdom/build/package/modules/class.js","snabbdom/build/package/modules/style":"../node_modules/snabbdom/build/package/modules/style.js","snabbdom/build/package/modules/props":"../node_modules/snabbdom/build/package/modules/props.js","snabbdom/build/package/modules/eventlisteners":"../node_modules/snabbdom/build/package/modules/eventlisteners.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
